...
;!function (a) {
    ...
    a.laydate = function (b) {
        ...
        //zzh add,for myangular.js datetime
        a.laydate_cc = function (b) {
            b = b || {};
            try {
                h.event = a.event ? a.event : laydate.caller.arguments[0]
            } catch (d) {
            }
            return c.run_cc(b), laydate_cc
        },
    laydate.v = "1.1", c.getPath = function () {
        ...
        c.run_cc = function (a) {
            ...
            e = a.event || "click";
            c.each((0 | d.length) > 0 ? d : [d], function (b, d) {
                c.stopMosup(e, d), c.on(d, e, function (b) {
                    c.stopmp(b), d !== c.elem && (c.view(d, a), c.reshow())
                })
            })
