...
public class AdminComputeFrameworkController extends BaseController {
    ...
    public Page<ComputeFramework> getPage(@RequestBody DtoComputeFramework req) {
        return computeFrameworkService.findAll(PageRequest.of(req.pageNo - 1, req.pageSize));
    }
